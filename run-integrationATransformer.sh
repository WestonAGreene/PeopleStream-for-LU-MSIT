...
mvn exec:java -Dexec.mainClass="peopleStream.integrationATransformer" -Dexec.args="./.confluent/java.config.sensitive integration-a--retriever person-canon--input"
