...
mvn exec:java -Dexec.mainClass="integrationAReciever.integrationAReciever" -Dexec.args="./.confluent/java.config.sensitive marketing-automation-platform--retriever"
