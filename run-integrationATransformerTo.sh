...
mvn exec:java -Dexec.mainClass="peopleStream.integrationATransformerTo" -Dexec.args="./.confluent/java.config.sensitive integration-a--updates-from-canon integration-a--updates"
