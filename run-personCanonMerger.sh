...
mvn exec:java -Dexec.mainClass="peopleStream.personCanonMerger" -Dexec.args="./.confluent/java.config.sensitive person-canon--input person-canon person-canon-table--input person-canon-table"
