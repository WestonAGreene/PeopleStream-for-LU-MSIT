...
mvn exec:java -Dexec.mainClass="peopleStream.integrationBTransformer" -Dexec.args="./.confluent/java.config.sensitive integration-b--retrieves person-canon--input"
