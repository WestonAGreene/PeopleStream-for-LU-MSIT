...
public class ProducerExample {
  ...
  public static Properties loadConfig(final String configFile) throws IOException {
    ...
    try (InputStream inputStream = new FileInputStream(configFile)) {
      System.out.printf("inputStream: %s", inputStream);
      inputStream = inputStream.replace("{{CONFLUENT_KAFKA_BROKER_USERNAME}}", System.getenv("CONFLUENT_KAFKA_BROKER_USERNAME"));
      inputStream = inputStream.replace("{{CONFLUENT_KAFKA_BROKER_PASSWORD}}", System.getenv("CONFLUENT_KAFKA_BROKER_PASSWORD"));
      System.out.printf("inputStream: %s", inputStream);
