...
public class integrationBTransformerFrom {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "integrationBTransformerFrom");
        ...
        final KStream<String, IntegrationB> recordsRetrieved = builder.stream(topicIn, Consumed.with(stringSerde, IntegrationB));
