...
public class integrationBRetriever {
  ...
  public static void main(final String[] args) throws IOException, InterruptedException {
    ...
    Producer<String, IntegrationB> producer = new KafkaProducer<String, IntegrationB>(props);
    ...
    while (!userInputKey.toLowerCase().equals("q")) {
        ...
        if (!userInputKey.toLowerCase().equals("q")) {
          ...
          IntegrationB record = new IntegrationB(userInputData);
          System.out.printf("Producing record: %s\t%s%n", userInputKey, record);
          producer.send(new ProducerRecord<String, IntegrationB>(topic, userInputKey, record), new Callback() {
              @Override
