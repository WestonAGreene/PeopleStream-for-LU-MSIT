...
mvn exec:java -Dexec.mainClass="peopleStream.integrationATransformerFrom" -Dexec.args="./.confluent/java.config.sensitive integration-a--retrieves person-canon--input"
